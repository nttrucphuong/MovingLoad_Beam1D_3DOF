...
//  /// </summary>
//  internal class SolverDirectNonlinearAnalysis : AbstractNonlinearSolver
//  {
//    /// <summary>
//    /// Constructor class
//    /// </summary>
...
//    public SolverDirectNonlinearAnalysis(AbstractModelStructure model, TypeNonlinearSolver type)
//      : base(model, type)
//    {
//    }
...
//    private DoubleVector SolveOneForSecondSubstepLoad(DoubleVector un0, DoubleVector un1, DoubleVector Fstep, DoubleVector residualForce0, DoubleVector residualForce1, DoubleSymmetricMatrix kGlobal, DoubleCsrSparseMatrix kGlobalSparse, out DoubleVector residualForce, double time)
//    {
//      // Last converged values: un
//      int nIter = 0;

//      DoubleVector deltaU = un1 - un0;
...
//      double alpha0 = 1.0;
//      double alpha1 = 1.0;
//      double alpha2 = alpha1 - 0.1;
//      double alpha3 = alpha1 + 0.1;
//      DoubleVector rf = MatrixFunctions.Product(kGlobalSparse, deltaU);
//      DoubleVector residualForceTemp1 = (1.0 + alpha1) * rf;
//      DoubleVector residualForceTemp2 = (1.0 + alpha2) * rf;
//      DoubleVector residualForceTemp3 = (1.0 + alpha3) * rf;
