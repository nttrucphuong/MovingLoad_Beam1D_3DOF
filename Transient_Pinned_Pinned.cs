...
namespace SampleTesting
{
  internal static class Transient_Pinned_Pinned
  {
    ...
    static void Main()
    {
      ...
      curve.pRefinement(2);
      curve.hRefinement(29); //inssert KVector - incerease p, min luoi
      ...
      //double V0 = 0.5;
      double[] arrV = new double[6] { 272.5676853, 204.425764, 168.1742618, 136.2838426, 68.14192132, 13.62753107 * 0.95 };
      ...
      FunctionRToR positionLoad = new PolynomialFunctionRToR();
      ...
      int[] arrNum = new int[6] { 160, 160, 2022, 624, 2496, 6238 }; // { 83, 77, 110, 116, 116, 140 }
